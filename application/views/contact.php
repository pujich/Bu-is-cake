			...
			<div class="row">
				<div class="col-md-6 p-b-30">
					<div class="p-r-20 p-r-0-lg">
						<div class="contact-map size21" id="google_map" data-map-x="-7.360406" data-map-y="112.735562" data-pin="images/icons/icon-position-map2.png" data-scrollwhell="0" data-draggable="1"></div>
					</div>
				</div>
				...
				<div class="col-md-6 p-b-30">
					...
					<h5 class="m-text26 p-b-36 p-t-15">
						Alamat: Delta Sari Indah BM-02 Waru, Koreksari, Kureksari, Sidoarjo, Kabupaten Sidoarjo, Jawa Timur 61256
					</h5>

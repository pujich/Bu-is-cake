		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 p-b-30">
					...
					<p class="p-b-28">
						<b>Q: Bagaimana cara saya mengorder?</b>
					</p>

					<div class="bo13 p-l-29 m-l-9 p-b-10">
						<p class="p-b-11">
							Untuk mengorder, anda dapat memilih add to cart pada pilihan kue yang anda inginkan. setelah itu, lakukan pembayaran dan barang akan segera dikirim oleh pemilik. Jika pembayaran telah usai dan barang telah dikirimkan, maka Keranjang belanja anda akan kembali kosong.
						</p>
					...
					<p class="p-b-28">
						<b>Q: Bagaimana saya membayar?</b>
					</p>

					<div class="bo13 p-l-29 m-l-9 p-b-10">
						<p class="p-b-11">
							 Informasi dapat didapatkan dibawah halaman 'Cart' atau dapat transfer ke <b>BCA Rekening: 372 3103728</b> dan konfirmasikan pembayaran kepada pemilik.
						</p>
					...
					<p class="p-b-28">
						<b>Dimana saya bisa menghubungi pemilik?</b>
					</p>

					<div class="bo13 p-l-29 m-l-9 p-b-10">
						<p class="p-b-11">
							A: Anda dapat mendapatkan informasi tentang lokasi dan kontak kami dalam tab 'Contact'
						</p>
